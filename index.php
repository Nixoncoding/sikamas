...
<head>
  ...
  <title>SIMKARTA</title>
  <meta content="SIMKARTA, Sistem Manajemen KAS RT/RW" name="description">
  <meta content="simkarta, kas, warga, kas online" name="keywords">

  <!-- Favicons -->
  <link href="<?= base_url('assets/img/SIMKARTA_logo.png'); ?>" rel="icon">
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="<?= base_url(); ?>">SIMKARTA</a></h1>
      ...
      <nav id="navbar" class="navbar ml-auto">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#contact">Kontak&Pembayaran</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <h2>di Sistem Manajemen Kas RT/RW</h2>
  ...
  <main id="main">
    ...
    <section id="kegiatan" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Kegiatan</h2>
          <p>Berikut ini adalah data mengenai kegiatan yang didanai menggunakan Kas Warga.</p>
        </div>
    ...
    <section id="laporan" class="pricing">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Laporan Kas</h2>
          <p>Setiap data yang masuk ke kas, selalu terdapat PJ (Penanggung Jawab) agar memudahkan dalam koordinasi antara pengurus dan warga.</p>
        </div>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Kontak&Pembayaran</h2>
          <p>Kontak ini diberikan sebagai pusat informasi jika pengguna/warga memerlukan informasi lainnya.</p>
        </div>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="phone">
                ...
                <h4>Call: Pak Ahmad (RW)</h4>
                <p>+62 8121 23123 123</p>
              </div>
              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Call: Pak Wardi (RT)</h4>
                <p>+62 8121 12121 121</p>
              </div>
              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Call: Pak Said (Bendahara)</h4>
                <p>+62 8000 00001 100</p>
              </div>
              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Call: Pak Agung (Sekretaris)</h4>
                <p>+62 8000 00001 100</p>
              </div>
              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Call: Pak Adrian (Administrator)</h4>
                <p>+62 8000 00001 100</p>
              </div>
            </div>
