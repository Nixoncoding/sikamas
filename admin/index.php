    ...
    break;
        ...
        <head>
            ...
            <meta name="description" content="SIMKARTA - Sistem Manajemen Kas RT/RW">
            <meta name="author" content="Mark Otto, Jacob Thornton, Bootstrap contributors, and @menpc3o as templating admin dashboard">
            <meta name="keyword" content="simkarta, kas, warga, kas online">
            <meta name="generator" content="Jekyll v3.8.5">

            <title>SIMKARTA</title>

            <!-- favicon -->
            <link rel="shortcut icon" href="<?= base_url('assets/img/SIMKARTA_logo.png'); ?>" type="image/x-icon">
            <!-- Bootstrap core CSS -->
        ...
        <body>
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow fixed-top py-1">
                <a class="navbar-brand px-1" href="<?= base_url(); ?>">SIMKARTA</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <ul class="nav d-block d-md-none">
                        ...
                        <!-- Menu Keuangan dengan submenu Kas -->
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?page=keuangan">
                                <span data-feather="bar-chart-2"></span>
                                Keuangan
                            </a>
                            <ul class="submenu" style="display: <?= ($_GET['page'] == 'keuangan' || $_GET['page'] == 'kas') ? 'block' : 'none'; ?>;">
                                <li><a class="nav-link <?= ($_GET['page'] == 'kas') ? 'active' : ''; ?>" href="index.php?page=kas">Kas</a></li>
                            </ul>
                    ...
                    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
                        <div class="sidebar-sticky">
                            ...
                            <ul class="nav flex-column">
                                ...
                                <!-- Menu Keuangan dengan submenu Kas -->
                               <li class="nav-item">
    <a class="nav-link collapsed <?= (in_array($_GET['page'] ?? '', ['kas', 'riwayat'])) ? '' : 'collapsed'; ?>" href="#submenuKeuangan" data-toggle="collapse" aria-expanded="<?= (in_array($_GET['page'] ?? '', ['kas', 'riwayat'])) ? 'true' : 'false'; ?>" aria-controls="submenuKeuangan">
        <span data-feather="bar-chart-2"></span>
        Keuangan
    </a>
